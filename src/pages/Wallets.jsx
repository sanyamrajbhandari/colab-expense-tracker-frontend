    ...
    <div style={{ padding: "28px", background: "#0f1623", minHeight: "100vh" }}>
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "28px" }}>
        ...
        <button
          ...
          style={{ padding: "10px 20px", borderRadius: "10px", background: "#3b82f6", border: "none", color: "#fff", fontWeight: "600", cursor: "pointer" }}>
          + Add Wallet
        </button>
      </div>
      ...
      {showModal && (
        ...
        <div onClick={() => setShowModal(false)} style={{ position: "fixed", inset: 0, background: "rgba(0,0,0,0.7)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 100 }}>
          ...
          <div onClick={(e) => e.stopPropagation()} style={{ background: "#151f2e", borderRadius: "16px", padding: "32px", width: "380px", border: "1px solid rgba(255,255,255,0.08)" }}>

            {/* Modal Header */}
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "24px" }}>
              <h3 style={{ color: "#fff", margin: 0, fontSize: "20px" }}>Add New Wallet</h3>
              <button onClick={() => setShowModal(false)} style={{ background: "none", border: "none", color: "#8a9bbf", fontSize: "20px", cursor: "pointer" }}>✕</button>
            </div>

            {/* Wallet Name Input */}
            <label style={{ color: "#8a9bbf", fontSize: "14px" }}>Wallet Name</label>
            <input
            ...
            <label style={{ color: "#8a9bbf", fontSize: "14px" }}>Initial Balance</label>
            <div style={{ display: "flex", alignItems: "center", background: "#1e2a3a", borderRadius: "10px", border: "1px solid rgba(255,255,255,0.1)", marginTop: "8px", marginBottom: "16px", padding: "12px 16px" }}>
            ...
            {/* Wallet Color Picker */}
            <label style={{ color: "#8a9bbf", fontSize: "14px" }}>Wallet Color</label>
            <div style={{ display: "flex", gap: "10px", marginTop: "10px", marginBottom: "24px" }}>
              {colors.map((color) => (
                // Color circle: white border shows selected color
                <div
                  key={color}
            ...
            {/* Cancel / Add Wallet Buttons */}
            <div style={{ display: "flex", gap: "12px" }}>
              <button onClick={() => setShowModal(false)} style={{ flex: 1, padding: "12px", borderRadius: "10px", background: "#1e2a3a", border: "1px solid rgba(255,255,255,0.1)", color: "#8a9bbf", cursor: "pointer", fontSize: "14px" }}>
                Cancel
              </button>
              <button onClick={handleAddWallet} style={{ flex: 1, padding: "12px", borderRadius: "10px", background: "linear-gradient(135deg, #6366f1, #3b82f6)", border: "none", color: "#fff", cursor: "pointer", fontWeight: "600", fontSize: "14px" }}>
                Add Wallet
              </button>
            </div>

            {/* Footer Note */}
            <p style={{ color: "#3b4a5a", fontSize: "11px", textAlign: "center", marginTop: "20px", letterSpacing: "1px" }}>
